...
const menuItems = [
  ...
  { state: 'detail', type: 'swipe', name: 'Swipe', desc: 'you can move that..', icon: 'pets', stateTransition: Navigator.SceneConfigs.VerticalDownSwipeJump, backgroundColor: 'bisque' },
